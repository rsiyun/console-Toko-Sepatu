...
public class TransaksiDetailController extends AllSql{
    public void showTransaksiDetail() throws Exception{
        ...
        for (int i = 0; i < list.size(); i++) {
            System.out.println(list.get(i).getIdDetailTransaksi() + " "+ list.get(i).getTransaksi().getIdTransaksi() +" "+ list.get(i).getProdukDetail().getIdProdukDetail()+" "+ list.get(i).getQuantity()+" "+list.get(i).getHarga());
        }
    }
}
